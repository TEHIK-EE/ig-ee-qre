...
| Active as of 2023-12-12 | *Computable Name*:AHD |
...
```json
{
  ...
  "item" : [{
    ...
    "repeats" : false,
    "readOnly" : false,
    "answerValueSet" : "https://fhir.ee/ValueSet/patsiendi-elulopu-tahteavalduse-rakendumine"
  },
  {
    ...
    },
    {
      ...
      "repeats" : false,
      "readOnly" : false,
      "answerValueSet" : "https://fhir.ee/ValueSet/elu-sailitavast-sekkumisest-keeldumise-ulatus",
      "item" : [{
  ...
  },
  {
    ...
    "item" : [{
      ...
      "repeats" : false,
      "readOnly" : false,
      "answerValueSet" : "https://fhir.ee/ValueSet/koigist-ravisekkumistest-keeldumise-ulatus"
    },
    {
  ...
  },
  {
    ...
    "repeats" : false,
    "readOnly" : false,
    "answerValueSet" : "https://fhir.ee/ValueSet/palliatiivravi-ulatus",
    "item" : [{
      "extension" : [{
        "url" : "http://hl7.org/fhir/StructureDefinition/minLength",
        "valueInteger" : 4
  ...
  {
    "linkId" : "other-preferences",
    "code" : [{
      "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
      "code" : "other-preferences",
      "display" : "Muud elulõpu juhised ja eelistused, mis ei ole tervishoiutöötajatele kohustuslikud"
    }],
    "text" : "Muud elulõpu juhised ja eelistused, mis ei ole tervishoiutöötajatele kohustuslikud",
    "type" : "group",
    "required" : false,
    "repeats" : false,
    "item" : [{
      "linkId" : "other-preferences.preferred-death-location",
      "code" : [{
        "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
      ...
      "item" : [{
        ...
        "linkId" : "other-preferences.preferred-death-location.other",
        "code" : [{
          "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
          "code" : "specify",
          "display" : "Täpsustus"
        ...
        "type" : "text",
        "enableWhen" : [{
          "question" : "other-preferences.preferred-death-location",
          "operator" : "=",
          "answerCoding" : {
    ...
    {
      "linkId" : "other-preferences.people-by-side-death",
      "code" : [{
        "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
    ...
    {
      "linkId" : "other-preferences.religious-preferences",
      "code" : [{
        "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
    ...
    {
      "linkId" : "other-preferences.actions-after-death",
      "code" : [{
        "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
        "code" : "burial-wish",
      ...
      "item" : [{
        ...
        "linkId" : "other-preferences.actions-after-death.other",
        "code" : [{
          "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
          "code" : "specify",
          "display" : "Täpsustus"
        ...
        "type" : "text",
        "enableWhen" : [{
          "question" : "other-preferences.actions-after-death",
          "operator" : "=",
          "answerCoding" : {
    ...
    {
      "linkId" : "other-preferences.other-wishes",
      "code" : [{
        "system" : "https://fhir.ee/CodeSystem/patsiendi-elulopu-tahteavalduse-kysimustik",
        "code" : "other-wishes",
