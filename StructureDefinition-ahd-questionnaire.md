# AHDQuestionnaire - Küsimustike teenus v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **AHDQuestionnaire**

## Resource Profile: AHDQuestionnaire 

| | |
| :--- | :--- |
| *Official URL*:https://fhir.ee/qre/StructureDefinition/ahd-questionnaire | *Version*:1.0.0 |
| Draft as of 2024-01-01 | *Computable Name*:AHDQuestionnaire |
...
* Examples for this Profile: [AHD](Questionnaire-Questionnaire-AHD-Example.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ee.fhir.qre|current/StructureDefinition/StructureDefinition-ahd-questionnaire.json)
...
Other representations of profile: [CSV](StructureDefinition-ahd-questionnaire.csv), [Excel](StructureDefinition-ahd-questionnaire.xlsx), [Schematron](StructureDefinition-ahd-questionnaire.sch) 
...
```json
{
  ...
  "url" : "https://fhir.ee/qre/StructureDefinition/ahd-questionnaire",
  "version" : "1.0.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "patternUri" : "https://fhir.ee/CodeSystem/dokumendi-tyyp"
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://fhir.ee/ValueSet/patsiendi-elulopu-tahteavalduse-kysimustik"
      }
    },
    {
