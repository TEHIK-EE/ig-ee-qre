...
```json
{
  ...
  "item" : [{
    ...
    "code" : [{
      ...
      "code" : "pet-indication",
      "display" : "Minu tahteavaldus rakendub valikuga"
    }],
    "text" : "Minu tahteavaldus rakendub valikuga",
    "type" : "coding",
    "required" : true,
    "repeats" : false,
    "readOnly" : false,
    "answerValueSet" : "https://fhir.ee/CodeSystem/pet-kysimustik",
    "answerOption" : [{
      "valueCoding" : {
  ...
  },
  {
    ...
    "item" : [{
      ...
      {
        "valueCoding" : {
          "code" : "no-life-sustaining-or-health-improving-treatments-despite-palliative",
