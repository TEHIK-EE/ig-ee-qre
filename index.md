...
| Active as of 2026-09-18 | *Computable Name*:QRE |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-09-18T06:56:19+00:00",
  "publisher" : "TEHIK",
  "contact" : [{
    "name" : "TEHIK",
    "telecom" : [{
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-ahd-questionnaire.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/ahd-questionnaire"
      },
      "name" : "AHDQuestionnaire",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Questionnaire-Questionnaire-AHD-Example.html"
      }],
      "reference" : {
        "reference" : "Questionnaire/Questionnaire-AHD-Example"
      },
      "name" : "Patsiendi elulõpu tahteavaldus",
      "description" : "Näidis patsiendi elulõpu tahteavaldusest",
      "isExample" : true,
      "profile" : ["https://fhir.ee/qre/StructureDefinition/ahd-questionnaire"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
