...
| Active as of 2026-09-11 | *Computable Name*:QRE |
...
* SNOMED Clinical Terms&reg; (SNOMED CT&reg;): [HDECL](Questionnaire-Questionnaire-health-declaration.md)
...
```json
{
  ...
  "id" : "ee.fhir.qre",
  "url" : "https://fhir.ee/qre/ImplementationGuide/ee.fhir.qre",
  "version" : "1.0.0",
  "name" : "QRE",
  "title" : "Küsimustike teenus",
  "status" : "active",
  ...
  "definition" : {
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "valueUri" : "StructureDefinition-ee-health-declaration-questionnaire.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/ee-health-declaration-questionnaire"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-pet-all-or-some-refusal-of-treatment-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/pet-all-or-some-refusal-of-treatment-vs"
      },
      "name" : "Elu säilitavast sekkumisest keeldumise ulatus",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-pet-all-intervention-refusal-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/pet-all-intervention-refusal-vs"
      },
      "name" : "Kõigist ravisekkumistest keeldumise ulatus",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-pet-palliative-care-fully-or-not-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/pet-palliative-care-fully-or-not-vs"
      },
      "name" : "Palliatiivravi ulatus",
      "description" : "Alamhulk mõisteid PET küsimustiku koodisüsteemist, mille järgi on võimalik valida palliatiivravi ulatus (kas soovida täiel määral palliatiivravi või loobuda defineeritud sekkumistest).",
      "isExample" : false
    },
    {
      "extension" : [{
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Questionnaire-Questionnaire-PET.html"
      }],
      "reference" : {
        "reference" : "Questionnaire/Questionnaire-PET"
      },
      "name" : "Patsiendi elulõpu tahteavaldus",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-pet-indication-vs.html"
      }],
      "reference" : {
        "reference" : "ValueSet/pet-indication-vs"
      },
      "name" : "PET tahteavalduse rakendumise valikud",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-pet-questionnaire.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/pet-questionnaire"
      },
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "CodeSystem-sagedus-ajas.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-sagedus-ajas.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Questionnaire-Questionnaire-health-declaration-with-text.html"
      }],
      "reference" : {
        "reference" : "Questionnaire/Questionnaire-health-declaration-with-text"
      },
      "name" : "Tervisedeklaratsioon",
      "description" : "Näidis töötervishoiu tervisedeklaratsiooni küsimustikust",
      "isExample" : true,
      "profile" : ["https://fhir.ee/qre/StructureDefinition/ee-health-declaration-questionnaire"]
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Questionnaire-Questionnaire-health-declaration.html"
      }],
      "reference" : {
        "reference" : "Questionnaire/Questionnaire-health-declaration"
      },
      "name" : "Tervisedeklaratsioon",
      "description" : "Näidis töötervishoiu tervisedeklaratsiooni küsimustikust",
      "isExample" : false,
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Questionnaire-Questionnaire-health-declaration-cda.html"
      }],
      "reference" : {
        "reference" : "Questionnaire/Questionnaire-health-declaration-cda"
      },
      "name" : "Tervisedeklaratsioon CDA-st",
    ...
    },
    {
      ...
      "value" : "https://fhir.ee/qre/history.html"
    },
    {
      "code" : {
        "system" : "http://hl7.org/fhir/tools/CodeSystem/ig-parameters",
